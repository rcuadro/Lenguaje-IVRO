...
public class Repeat extends Bucle{
	private Expresion exp;
	private ArrayList<Instruccion> cpo;
	
	public Repeat(Expresion e, ArrayList<Instruccion> c) {
		this.exp = e;
		this.cpo = c;
	}
	...
	public void checkTipo() {
		...
		if(!exp.getTipo().equals(new TBasicos(KindT.TBOO))){
			System.out.println("ERROR: se esperaba una expresión booleana en REPEAT " + this);
			Programa.setFin();
		}
		else{
